 ...
 * @link https://stackoverflow.com/questions/6481627/java-security-illegal-key-size-or-default-parameters
...
public class WXBizMsgCrypt {
    ...
    public String decryptMsg(String msgSignature, String timeStamp, String nonce, String postData)
            throws AesException {
        logger.debug("msgSignature = [" + msgSignature + "], timeStamp = [" + timeStamp + "], nonce = [" + nonce + "], postData = [" + postData + "]");
        // 密钥，公众账号的app secret
        // 提取密文
    ...
    public String verifyUrl(String msgSignature, String timeStamp, String nonce, String echoStr)
            throws AesException {
        logger.debug("msgSignature = [" + msgSignature + "], timeStamp = [" + timeStamp + "], nonce = [" + nonce + "], echoStr = [" + echoStr + "]");
